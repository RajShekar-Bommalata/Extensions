 ...
 * 
 * eureQa Custom logic starts here  
 */
LocatorBuilders.getRecorder = function(window) {
	return Recorder.get(window);
};
LocatorBuilders.add('accessor', function(window) {
