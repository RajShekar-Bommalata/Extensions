...
bot.Keyboard.checkCanUpdateSelection_ = function(a) {    
     ...
     * 
     * doType command issue with input[type="email"] fix
     */
    try {
 ...
 * 
 * sendKeysTabOut and sendKeysEnter functionality  
 */
bot.action.pressEnterAfterSendKeys = function() {
    var f = new bot.Keyboard;
    f.pressKey(bot.Keyboard.Keys.ENTER);
    var b = f.isPressed(bot.Keyboard.Keys.ENTER);
};
bot.action.pressTabOutAfterSendKeys = function() {
    var f = new bot.Keyboard;
    f.pressKey(bot.Keyboard.Keys.TAB);
    var b = f.isPressed(bot.Keyboard.Keys.TAB);
};
